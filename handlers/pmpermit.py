    ...
    if PMPERMIT == "ENABLE":
        if PMSET:
            ...
            await USER.send_message(
                message.chat.id,
            f"** اهلا انا مشغول حاليا** ، \n\n❗️ **ملاحظه:**\n\n• لا تقم بتكرار الرسائل .\n• لا ترسل لي شي سري confidential\n\n• انضم الا [𝗙𝗲𝗲𝗹𝗶𝗻𝗴 ♪](t.meNvvvM) \n• انضم الا - [𝗠𝗶𝗿𝗮 𝗠𝘂𝘀𝗶𝗰](t.me/Xkkku)\n\n💁🏻‍♂️ المطور: [𝐀 𝐋 𝐎 𝐍 𝐄](t.me/C1CiC)\n\n",
            )
            return
...
async def autopmPermiat(client: USER, message: Message):
    ...
    if not chat_id in pchats:
        ...
        await message.reply_text("تمت المواقه على PM بسبب الرسائل الصادره")
        return
