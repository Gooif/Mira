...
def song(client, message):
    ...
    try:
        ...
        m.edit("حدث خطا ،\n\nرجاء اكتب اسم الاغنيه بشكل صحيح.")
        print(str(e))
        return
    ...
    try:
        ...
        m.edit("✘ لم يتم العثور على الملف المطلوب")
        print(e)
...
async def ytmusic(client, message: Message):
    ...
    if is_downloading:
        await message.reply_text(
            "حدث خطاء في قاعدة البيانات، حاول مرا اخرى بعد وقت ما،"
        )
        return
    ...
    capy = f"✨ **اسم الفيديو :** __{thum}__ \n **تم التحميل بواسطة:** __{urlissed}__ \n **القناة :** __{thums}__ \n📌 **ʟɪɴᴋ :** [click here]({mo})"
